...
OUTPUT_JSON = "outputs/timetable_T{trimester}.json"
OUTPUT_EXCEL = "outputs/timetable_T{trimester}.xlsx"
...
EXCLUDED_COURSES = ["Industrial Practice", "Diploma Work", "Educational Practice", "Undergraduate Practice"]
